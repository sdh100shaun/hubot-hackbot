...
describe('@hubot add @username to my team', () => {
  ...
  describe('when in a team', () => {
    ...
    let userId = 'micah';
    let userEmail = 'micah.micah~micah';
    let otherUserId = 'polly';
    let otherUserUsername = 'abcdefghijklmnopqrstuvwxyz.-_0123456789';
    let existingTeamId = 'ocean-mongrels';
    let existingTeamName = 'Ocean Mongrels';
    ...
    before(() => {
     ...
     const addUserToTeamStub = sinon.stub().returns(Promise.resolve({ ok: true }));
